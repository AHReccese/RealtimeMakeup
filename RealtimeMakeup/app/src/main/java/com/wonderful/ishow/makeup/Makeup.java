...
*/
        ...
        Log.v("Time: ", "EyeBrow Native Call: " + (afterLoad - startTime));
    ...
    public void applyEyeLash(Bitmap mask, int color, float amount) {
        ...
        long afterLoad = System.currentTimeMillis();
        Log.v("Time: ", "EyeLash Native Call: " + (afterLoad - startTime));
    ...
    public void applyEyeShadow(@NonNull final Bitmap[] masks, @NonNull final int[] colors, float amount) {
        ...
        long afterLoad = System.currentTimeMillis();
        Log.v("Time: ", "EyeShadow Native Call: " + (afterLoad - startTime));
    }
    ...
    public void applyIris(Bitmap iris, float amount) {
        ...
        long afterLoad = System.currentTimeMillis();
        Log.v("Time: ", "Iris Native Call: " + (afterLoad - startTime));
    }
    ...
    public void applyBlush(@BlushShape int shape, int color, float amount) {
        ...
        long afterLoad = System.currentTimeMillis();
        Log.v("Time: ", "Blush Native Call: " + (afterLoad - startTime));
    }
