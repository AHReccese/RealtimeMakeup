...
abstract class BaseActivity extends Activity {
	...
	// todo -> inheritance Vs composition
	...
	protected void requestPermission(final String permission, String message, final int requestCode) {
		if(ActivityCompat.shouldShowRequestPermissionRationale(this, permission)) {
			// show explanation -> so no need to blocking.
			...
			new AlertDialog.Builder(this)
				...
				.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						// after reading rational explanation -> request permission.
			...
			// user hasn't been refused to get the permission previously
