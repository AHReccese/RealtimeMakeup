...
public class ColorUtils {
	/**
	 * #Color use #AARRGGBB, namely A_R_G_B in memory layout, while native layer use #AABBGGRR, namely
	...
	public static int[] obtainColorArray(Resources res, @ArrayRes int resId) {
		...
		for(int i = 0; i < length; ++i)
		    resIds[i] = array.getColor(i, Color.BLACK);  // fall back to black color.
